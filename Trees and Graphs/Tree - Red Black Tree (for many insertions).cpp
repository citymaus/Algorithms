...
void RedBlack::Insert(const Key& key, const Value& value)
{
	RedBlackNode *node, *parent, *z;
...
Value& RedBlack::Find(const Key& key)
{
...
void RedBlack::Delete(const Key& key)
{
	RedBlackNode *node = root;
	while (node)
	{
...
void RedBlack::RotateLeft(RedBlackNode *x)
{
	RedBlackNode *y;
...
void RedBlack::RotateRight(RedBlackNode *y)
{
	RedBlackNode *x;
...
void RedBlack::Transplant(RedBlackNode *dest, RedBlackNode *src)
{
	if (dest->parent == NULL)
	{
		root = src;
...
RedBlackNode RedBlack::*Minimum(RedBlackNode *tree)
{
	while (tree->left)
	{
		tree = tree->left;
...
void RedBlack::Dump(RedBlackNode *node, int tabs)
{
	if (!node)
	{
		return;
