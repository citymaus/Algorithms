/*
  ...
  - Not great for small data sets
  - By using input array as storage for heap, it is possible to achieve constant space
  - Does not preserve order of keys with equal values
	----------------------------------
